...
<?php
    ...
    **/
    ...
    if (isset($_POST['cajitaDOS'])) {
        $sql2="UPDATE ZONAS SET Estado_luz=1 WHERE ZONAS.PREDIO_Id_Predio=".$idPred." AND Nombre_area='Comedor'";
        $result2=mysqli_query($conexion,$sql2);
    } else {
        $sql3="UPDATE ZONAS SET Estado_luz=0 WHERE ZONAS.PREDIO_Id_Predio=".$idPred." AND Nombre_area='Comedor'";
